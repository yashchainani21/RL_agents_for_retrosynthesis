...
Legacy interfaces (deprecated, will be removed in a future release):
- RolloutPolicy: Replaced by TerminalDetector
- RolloutResult: Replaced by TerminalDetectionResult
"""
...
# ---------------------------------------------------------------------------
# New abstractions (replacing RolloutPolicy / RolloutResult)
# ---------------------------------------------------------------------------
