...
def test_if_reactant_template_pair_duplicates_were_correctly_identified():
    """
    Ensure all duplicate reaction-template pairs arising from the above datasets were correctly identified.
    Do this by ensuring all reactant-template pairs in the list of duplicates appear at least once in the unique list.
    """
